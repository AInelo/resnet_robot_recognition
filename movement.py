...
def initialize_arm():
    ...
    arm.Arm_serial_servo_write6(93, 87, 89, 2, 89, 178, 1000)
    time.sleep(2)
...
def move_arm_to_cube(cube_position):
    if cube_position:
        ...
        arm.Arm_serial_servo_write(1, angle_1, 1000)
...
def take_cube():
    ...
    arm.Arm_serial_servo_write6(93, 82, 14, 32, 89, 178, 1000)
    time.sleep(2)

    print("Approche de l'objet")
    arm.Arm_serial_servo_write6(94, 64, 11, 43, 89, 101, 1000)
    time.sleep(2)

    print("Attrape l'objet")
    arm.Arm_serial_servo_write6(94, 32, 52, 20, 89, 153, 1000)
    time.sleep(2)

    print("Soulève l'objet")
    arm.Arm_serial_servo_write6(93, 111, 2, 28, 89, 153, 1000)
    time.sleep(2)

    print("Mise en l'air de l'objet")
    arm.Arm_serial_servo_write6(94, 87, 74, 74, 89, 153, 1000)
    time.sleep(2)


def move_to_yellow_place():
    print("Start deposit on yellow box")
    arm.Arm_serial_servo_write6(54, 91, 46, 60, 89, 157, 1000)
    time.sleep(2)

    print("Continuation de la position")
    arm.Arm_serial_servo_write6(67, 14, 77, 37, 89, 157, 1000)
    time.sleep(2)

    print("Relâche l'objet")
    arm.Arm_serial_servo_write6(67, 14, 77, 37, 89, 107, 1000)
    time.sleep(2)
...
def move_to_green_place():
    ...
    arm.Arm_serial_servo_write6(141, 101, 42, 10, 89, 157, 1000)
    time.sleep(2)

    print("Continuation de la position")
    arm.Arm_serial_servo_write6(141, 67, 31, 7, 89, 159, 1000)
    time.sleep(2)

    print("Relâche l'objet")
    arm.Arm_serial_servo_write6(141, 67, 31, 7, 89, 109, 1000)
    time.sleep(2)
...
def move_to_red_place():
    ...
    arm.Arm_serial_servo_write6(129, 84, 66, 34, 89, 153, 1000)
    time.sleep(2)

    print("Evolution de la position")
    arm.Arm_serial_servo_write6(120, 58, 51, 30, 89, 163, 1000)
    time.sleep(2)

    print("positione bien l'objet")
    arm.Arm_serial_servo_write6(120, 19, 60, 53, 89, 163, 1000)
    time.sleep(2)


    print("Relâche l'objet")
    arm.Arm_serial_servo_write6(120, 19, 60, 53, 89, 105, 1000)
    time.sleep(2)
...
def move_to_blue_place():
    ...
    arm.Arm_serial_servo_write6(39, 108, 38, 32, 89, 179, 1000)
    time.sleep(2)

    print("Continuation de la position")
    arm.Arm_serial_servo_write6(47, 83, 9, 21, 89, 179, 1000)
    time.sleep(2)

    print("Relâche l'objet")
    arm.Arm_serial_servo_write6(47, 83, 9, 21, 89, 109, 1000)
    time.sleep(2)
    # Position intermédiaire
    arm.Arm_serial_servo_write6(93, 87, 89, 2, 89, 178, 1000)
    time.sleep(2)
